...
<div class="ReleaseWrapper myPopupWrapper">
    <div class="row">
        ...
        <div class="myenrollmentdobcontainer">
            ...
            <asp:RequiredFieldValidator ID="reqreleaseDate" runat="server" SetFocusOnError="true"
                Display="Dynamic" ControlToValidate="RadDatePickerReleaseDate" ValidationGroup="SaveRelease"
                CssClass="ErrorMessage" ErrorMessage="Release Date is required." Text="Release date is required*"></asp:RequiredFieldValidator>
            <asp:CustomValidator ID="reldateWeekeday" ControlToValidate="RadDatePickerReleaseDate" runat="server" SetFocusOnError="true"
                ValidationGroup="SaveRelease" Display="Dynamic" CssClass="ErrorMessage"
                ErrorMessage="Release Date has to be on weekday." Text="Release Date cannot be on weekend or federal holiday." OnServerValidate="CustomValidatorWeekend_ServerValidate"
                ClientValidationFunction="DateSelectedIsWeekday"></asp:CustomValidator>

            <script type="text/javascript">
                function DateSelectedIsWeekday(source, arguments) {
                    selDate = arguments.get_newValue();
                    alert(selDate);
