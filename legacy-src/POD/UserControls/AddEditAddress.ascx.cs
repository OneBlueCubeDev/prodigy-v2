...
namespace POD.UserControls
{
    public partial class AddEditAddress : System.Web.UI.UserControl
    {
        ...
        private void LoadLists()
        {
            ...
            //change for state dropdown - 12/16/2020

            if (this.RadComboBoxState.Items.Count == 0)
            {
                this.RadComboBoxState.DataSource = POD.Logic.LookUpTypesLogic.GetStates();
                this.RadComboBoxState.DataBind();
            }
