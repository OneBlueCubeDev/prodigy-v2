    ...
    <ul>
     ...
     <auth:SecureContent ID="SecureContent2" ToggleVisible="True" ToggleEnabled="False" EventHook="Load" runat="server" Roles="Administrators;Administrators-NA;CentralTeamUsers;SiteTeamUsers;SiteTeamUsers-NA">
        ...
        <li id="LiReviewLessonPlan" runat="server">
              <!--<auth:SecureContent ID="SecureContent1" ToggleVisible="True" ToggleEnabled="False" EventHook="Load" runat="server" Roles="Administrators;Administrators-NA;CentralTeamUsers;SiteTeamUsers;;SiteTeamUsers-NA"> -->
            <a runat="server" href="~/Pages/LessonPlans/ReviewLessonPlans.aspx"
