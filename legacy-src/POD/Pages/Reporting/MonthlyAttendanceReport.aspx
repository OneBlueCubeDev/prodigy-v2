<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/Markup/AdminWide.Master"
    AutoEventWireup="true" CodeBehind="MonthlyAttendanceReport.aspx.cs" Inherits="POD.Pages.Reporting.MonthlyAttendanceReport" %>
    ...
    <div class="tabcontainer widetabcontainer">
        <div class="tabcontent">
            <div class="RunReportContainer">
                ...
                <div class="myreporttargetdatecontainer">
                    ...
                    <telerik:RadMonthYearPicker ID="DatePickerTargetDate" runat="server" Width="52%"
                        ...
                        OnSelectedDateChanged="DatePickerTargetDate_OnSelectedDateChanged" AutoPostBack="True"
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="LabelDropDownCourseInstances" AssociatedControlID="DropDownCourseInstances"
                    runat="server">Class</asp:Label>
                <telerik:RadComboBox ID="DropDownCourseInstances" runat="server" AppendDataBoundItems="False"
                    EnableEmbeddedSkins="false" SkinID="Prodigy" Width="500px" DataTextField="Name" DataValueField="CourseInstanceID"
                    CssClass="mydropdown">
                    <Items>
                            <telerik:RadComboBoxItem Text="All Classes" Value="" />
                        </Items>
                </telerik:RadComboBox>

                <asp:RequiredFieldValidator ID="CourseInstanceValidator" runat="server" ControlToValidate="DropDownCourseInstances"
                    Display="None" ErrorMessage="You must pick a class to run the report." CssClass="ValidationClass"
                    ValidationGroup="ReportParameters">
                </asp:RequiredFieldValidator>
            ...
            <asp:ValidationSummary ID="ValidationSummary" runat="server" ValidationGroup="ReportParameters"
                DisplayMode="List" />
            <uc:ReportViewport ID="ReportViewport" runat="server" ReportName="MonthlyAttendanceReport" />
        </div>
