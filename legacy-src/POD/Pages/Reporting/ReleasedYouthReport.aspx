...
<div class="myreporttargetdatecontainer">
                    <asp:Label ID="LabelReleaseDate" AssociatedControlID="DatePickerReleaseDate" runat="server">Month</asp:Label>
                    <telerik:RadMonthYearPicker ID="DatePickerReleaseDate" runat="server" Width="52%"
