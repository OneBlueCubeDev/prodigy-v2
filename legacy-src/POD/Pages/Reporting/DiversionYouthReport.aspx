<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/Markup/AdminWide.Master" AutoEventWireup="true" CodeBehind="DiversionYouthReport.aspx.cs" Inherits="POD.Pages.Reporting.DiversionYouthReport" %>
    ...
    <div class="tabcontainer widetabcontainer">
        <div class="tabcontent">
            ...
            <asp:ValidationSummary ID="ValidationSummary" runat="server" ValidationGroup="ReportParameters"
                DisplayMode="List" />
            <uc:ReportViewport ID="ReportViewport" runat="server" ReportName="DiversionYouthReport" />
        </div>
    </div>    
</asp:Content>
