<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/Markup/AdminWide.Master"
    AutoEventWireup="true" CodeBehind="CensusReport.aspx.cs" Inherits="POD.Pages.Reporting.CensusReport" %>
...
<%--                    <script language ="text/javascript">
            ...
            <asp:ValidationSummary ID="ValidationSummary" runat="server" ValidationGroup="ReportParameters"
                DisplayMode="List" />
            <uc:ReportViewport ID="ReportViewport" runat="server" ReportName="CensusReportV2" />
        </div>
    </div>
</asp:Content>
