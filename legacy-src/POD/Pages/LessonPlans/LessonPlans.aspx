            ...
            <Columns>
             ...
             <telerik:GridTemplateColumn ItemStyle-HorizontalAlign="Center" >
                ...
                <telerik:GridTemplateColumn ItemStyle-Width="5%" HeaderStyle-HorizontalAlign="Center" 
                 ...
                 <telerik:GridTemplateColumn ItemStyle-Width="5%"  HeaderStyle-HorizontalAlign="Center" 
                            UniqueName="PrintLessonPlansColumn" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="5%"
                            ShowFilterIcon="False" HeaderTooltip="Print Lesson Plans">
                            <ItemTemplate>
                                <asp:ImageButton ID="PrintLPButton" runat="server" CssClass="IconButton" CommandName="PrintLessonPlanSet"
                                    CommandArgument="CopyLesson" ImageUrl="~/Templates/Images/print.png"
                                    ToolTip="Print all the Lesson Plans" Height="32px" Width="32px"/>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
             </Columns>
            <DetailTables>
   ...
   <table >
            ...
            <td width="30%">
                <asp:LinkButton ID="LinkButton9" Text="Refresh data" CommandName="Rebind" runat="server"></asp:LinkButton>
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Location.Name" SortExpression="Location.Name" UniqueName="colSite"
                            HeaderText="Site">
                        </telerik:GridBoundColumn>
    ...
    <asp:EntityDataSource ID="DataSourceLessonPlan" runat="server" ConnectionString="name=PODContext"
      DefaultContainerName="PODContext"  EnableFlattening="False" EntitySetName="LessonPlans"
        Include="DisciplineType,AgeGroup,Site,Location" OrderBy="it.[Name]" Where="it.[LessonPlanSetID] == @LessonPlanSetID">
        <WhereParameters>
