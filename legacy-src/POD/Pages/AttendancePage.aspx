            ...
            <div class="CourseOverview">
                ...
                <asp:Panel ID="PanelClassRecord" runat="server" CssClass="AttendanceInfo">
                    ...
                    EventHook="Load" runat="server" Roles="Administrators;CentralTeamUsers;SiteTeamUsers;">
                        ...
                        <div class="row">
                            <asp:Label ID="Label2" runat="server" Text="Alternate Activity" CssClass="mylabel"></asp:Label>
                            <asp:RadioButtonList ID="RadiobuttonListAlternate" runat="server" CssClass="TardyFields"
                                RepeatDirection="Horizontal">
                                <asp:ListItem Text="Yes" Value="True"></asp:ListItem>
                                <asp:ListItem Text="No" Value="False"></asp:ListItem>
                            </asp:RadioButtonList>
                    ...
                    EventHook="Load" runat="server" Roles="Administrators;CentralTeamUsers;SiteTeamUsers;SiteTeamUsers-NA;">
                        <div class="row">
                    ...
                    <telerik:RadGrid ID="RadGriAttendancesClass" runat="server" AutoGenerateColumns="false"
                        ...
                        <MasterTableView TableLayout="Auto" ClientDataKeyNames="Student_PersonID, ClassAttendanceID, ClassID"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="Class.DateStart" FilterControlWidth="45%" AutoPostBackOnFilter="true"
                                ...
                                <telerik:GridTemplateColumn SortExpression="IsAlternateActivity" HeaderText="Alternate Activity" HeaderStyle-HorizontalAlign="Center"
                                    ItemStyle-HorizontalAlign="Center" ItemStyle-Width="75px" HeaderStyle-Width="75px">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelAlternate" runat="server" Text='<%#  Eval("IsAlternateActivity")!=null && Eval("IsAlternateActivity").ToString() == "True"? "Yes":"No" %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridBoundColumn DataField="Notes" FilterControlWidth="85%" AutoPostBackOnFilter="true" ShowFilterIcon="false" SortExpression="Notes"
                                    ItemStyle-HorizontalAlign="Center" HeaderText="Notes">
                                </telerik:GridBoundColumn>
                            </Columns>
                            <NoRecordsTemplate>
                                <p>
