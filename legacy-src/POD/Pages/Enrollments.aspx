...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContentPlaceholder" runat="server">
    ...
    <telerik:RadGrid ID="RadGridEnrollments" runat="server" AutoGenerateColumns="false" OnItemDataBound="RadGridEnrollments_ItemDataBound"
    ...
    <telerik:RadContextMenu ID="RadMenuOptions" runat="server" OnItemClick="RadMenu1_ItemClick" 
        ...
        <Items>
            ...
            <telerik:RadMenuItem  Text="Release Youth" Visible="false"  Value="Release" PostBack="false" />
             <telerik:RadMenuItem IsSeparator="true"/>
             <telerik:RadMenuItem Text="View Discharge Form" Visible="false" PostBack="true" Value="Discharge" />
