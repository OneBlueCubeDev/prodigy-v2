<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/Markup/AdminWide.Master"
    AutoEventWireup="true" CodeBehind="ReleasedYouthReport.aspx.cs" Inherits="POD.Pages.Reporting.ReleasedYouthReport" %>
...
<%--                    <asp:Label ID="Label1" AssociatedControlID="DropDownGrantYear" runat="server">Select Grant Year</asp:Label>
                    <telerik:RadComboBox ID="DropDownGrantYear" runat="server" AppendDataBoundItems="True"
                        EnableEmbeddedSkins="false" SkinID="Prodigy" DataTextField="GrantYear" DataValueField="GrantYearID"
                        CssClass="mydropdown">
                        <Items>
