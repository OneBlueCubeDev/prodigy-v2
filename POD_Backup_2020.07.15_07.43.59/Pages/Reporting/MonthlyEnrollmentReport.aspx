<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/Markup/AdminWide.Master"
    AutoEventWireup="true" CodeBehind="MonthlyEnrollmentReport.aspx.cs" Inherits="POD.Pages.Reporting.MonthlyEnrollmentReport" %>
    ...
    <div class="tabcontainer widetabcontainer ReportingCensusContainer">
        <div class="tabcontent">
            <div class="RunReportContainer">
                ...
                <asp:RequiredFieldValidator ID="SitePickedValidator" runat="server" ControlToValidate="DropDownSites"
            ...
            <asp:ValidationSummary ID="ValidationSummary" runat="server" ValidationGroup="ReportParameters"
                DisplayMode="List" />
            <uc:ReportViewport ID="ReportViewport" runat="server" ReportName="MonthlyEnrollmentReport" />
        </div>
    </div>
</asp:Content>
