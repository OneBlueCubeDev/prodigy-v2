...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceholder" runat="server">
    <telerik:RadScriptBlock runat="server">
        <script type="text/javascript">
            ...
            $('#TextBoxWeek, #RadDatePickerStartTime, #RadDatePickerEndTime').bind('keyup', function () {
                if (allFilled()) $('#ButtonAddLifeskill').removeAttr('disabled');
            });
                ...
                <asp:Panel ID="PanelContent" class="FormWrapper" runat="server">
                    ...
                    <telerik:RadDatePicker ID="RadDatePickerStart" runat="server" DateInput-Width="150px" Width="150px" 
                        ...
                        Calendar-CssClass="myfield myDatePickerPopup" CssClass="myDatePickerPopup myenrollmentdate-new">
                            ...
                            <asp:RangeValidator ID="rvlpdates" runat="server" ErrorMessage="Lesson Plan date needs to be between the dates of the lesson plan set" ControlToValidate="RadDatePickerStart" Display="Dynamic" Type="Date" ValidationGroup="saveLessonPlan" ></asp:RangeValidator >
                            </div>
                        <div class="InputWrapper row StartDateContainer">
                    <asp:Label ID="Label11" runat="server" Text="Start Time" CssClass="mylabel-right"></asp:Label>
                             <telerik:RadTimePicker RenderMode="Lightweight" ID="RadDatePickerStartTime" Width="150px" runat="server" Calendar-CssClass="myfield myDatePickerPopup" CssClass="myDatePickerPopup myenrollmentdate-new ">
                                 <TimeView runat="server" TimeFormat="hh:mm" StartTime="08:00" EndTime="17:00" Interval="00:30" />
                        ...
                        <div class="InputWrapper row StartDateContainer">
                            ...
                            <telerik:RadTimePicker RenderMode="Lightweight" ID="RadDatePickerEndTime" Width="150px" runat="server" Calendar-CssClass="myfield myDatePickerPopup" CssClass="myDatePickerPopup myenrollmentdate-new ">
                                <TimeView runat="server" TimeFormat="hh:mm" StartTime="08:00" EndTime="17:30" Interval="00:30" />
                            </telerik:RadTimePicker>
                        ...
                        <div class="InputWrapper row LifeSkills">
                            ...
                            &nbsp;
                                <asp:Button CssClass="mybutton addLifeSkillbutton" runat="server" ID="ButtonAddLifeskill"
                                    Text="Add Life Skill" CausesValidation="true" OnClick="ButtonAddLifeskill_Click" />
...
<asp:RequiredFieldValidator runat="server" ID="rfv2" ControlToValidate="lifeskilltext" Display="Dynamic" ErrorMessage="Life Skill Is Required" Enabled="true" ValidationGroup="saveLessonPlan">
            ...
            <div class="InputWrapper row">
                ...
                &nbsp; &nbsp;
                <%-- Print  --%>
                <asp:Button runat="server" ID="ButtonPrint" Text="Print" CssClass="mybutton mycancel"
