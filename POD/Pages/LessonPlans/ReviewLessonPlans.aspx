                ...
                <MasterTableView ClientDataKeyNames="LessonPlanSetID" DataKeyNames="LessonPlanSetID, StatusTypeID,InstructorPersonID"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="DateTimeStamp" SortExpression="DateTimeStamp"
                            HeaderText="Created/Modified Date">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="LastModifiedBy" SortExpression="LastModifiedBy"
                        ...
                        <telerik:GridButtonColumn ButtonType="ImageButton" ItemStyle-Width="4%" CommandArgument="Delete"
                        ...
                        <telerik:GridTableView AllowSorting="true" AllowPaging="false" ShowHeader="true"
                            ...
                            <Columns>
                              ...
                              <telerik:GridBoundColumn DataField="WeekNumber" SortExpression="WeekNumber"
                                ...
                                <telerik:GridBoundColumn DataField="Locations.Name" SortExpression="Site.Name" UniqueName="colSite"
                                    HeaderText="Site">
                                </telerik:GridBoundColumn>
