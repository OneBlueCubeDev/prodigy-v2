        ...
        <div class="tabcontent">
            <auth:SecureContent ID="SecureContent3" ToggleVisible="false" ToggleEnabled="true"
                ...
                <div class="InventoryItemWrapper">
                    ...
                    <div class="row">
                        <asp:Label ID="Label12" runat="server" Text="Room" CssClass="mylabel"></asp:Label>
                        <asp:TextBox ID="txtroom" runat="server" CssClass="myfield"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvRoom" runat="server" ErrorMessage="Room is required"
                            CssClass="ErrorMessage" Display="Dynamic" ValidationGroup="Save" ControlToValidate="txtroom"></asp:RequiredFieldValidator>
                    </div>
                </div>
            </auth:SecureContent>
        </div>
