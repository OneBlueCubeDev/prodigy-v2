...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContentPlaceholder" runat="server">
    ...
    <div class="tabcontainer">
        <div class="tabcontent"><div id="home"></div>
            ...
            <div class="EnrollmentFormContainer RiskAssessmentFormContainer">
                ...
                <asp:RequiredFieldValidator ID="reqValPATCompletedDate" runat="server" SetFocusOnError="true"
                    ...
                    CssClass="ErrorMessage" ErrorMessage="Completed Date is required" Text="* Required" Enabled="True" ></asp:RequiredFieldValidator>

                <div class="row">
                    <div class="">
                        <asp:Label ID="lblpatenteredby" runat="server" Text="PAT Completed By:" CssClass="mylabel"></asp:Label>
                        <asp:TextBox ID="txtpatenteredby" runat="server" CssClass="MiddleName myfield capitalize"></asp:TextBox>
                ...
                <telerik:RadTabStrip ID="sectionsTab" runat="server" SelectedIndex="0"
                    MultiPageID="MultiPageRiskAssessment" Orientation="HorizontalTop" CssClass="PATSections">
                </telerik:RadTabStrip>
