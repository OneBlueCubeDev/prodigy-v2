        ...
        <div class="tabcontent">
            ...
            <telerik:RadGrid ID="RadGriAttendances" runat="server" AutoGenerateColumns="false"
                ...
                <MasterTableView TableLayout="Auto" ClientDataKeyNames="PersonID, RecordID, RecordType"
                    ...
                    <Columns>
                        <telerik:GridBoundColumn DataField="ClassName" FilterControlWidth="65%" ItemStyle-Width="345px" HeaderStyle-Width="345px" SortExpression="ClassName"
                        ...
                        <telerik:GridBoundColumn DataField="AttendanceDate" FilterControlWidth="85%" AutoPostBackOnFilter="true"
                            ShowFilterIcon="false" SortExpression="AttendanceDate" ItemStyle-Width="45px" HeaderStyle-Width="45px" HeaderText="Attendance Date" DataFormatString="{0:d}">
                        </telerik:GridBoundColumn>
