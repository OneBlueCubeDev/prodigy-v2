...
{
    public partial class ReturningYouthReport : Page, IReportParametersContainer
    {
        ...
        public IEnumerable<ReportParameter> ReportParameters
        {
            get
            {
                ...
                yield return new ReportParameter("enrollmentTypeId",
                                                 string.IsNullOrEmpty(DropDownEnrollmentTypes.SelectedValue)
                                                     ? null
                                                     : DropDownEnrollmentTypes.SelectedValue);
            }
        }
        ...
        private void BindEnrollmentTypes()
        {
            DropDownEnrollmentTypes.DataSource = ManageTypesLogic.GetTypesByType(TypesData.Types.EnrollmentType);
            DropDownEnrollmentTypes.DataBind();
        }
