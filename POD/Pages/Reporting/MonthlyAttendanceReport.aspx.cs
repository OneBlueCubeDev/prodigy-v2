    ...
    public partial class MonthlyAttendanceReport : Page, IReportParametersContainer
    {
        ...
        public IEnumerable<ReportParameter> ReportParameters
        {
            get
            {
                ...
                yield return new ReportParameter("courseInstanceId", string.IsNullOrEmpty(DropDownCourseInstances.SelectedValue)
                                                     ? null
                                                     : DropDownCourseInstances.SelectedValue);
        ...
        protected void DropDownSites_OnSelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
                ...
                && siteLocationId > 0)
            {
                ...
                DropDownCourseInstances.Items.Insert(0, new RadComboBoxItem("All Classes", string.Empty));
            }
        }
