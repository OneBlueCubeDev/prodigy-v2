<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/Markup/AdminWide.Master" AutoEventWireup="true" CodeBehind="DeletedEnrollmentReport.aspx.cs" Inherits="POD.Pages.Reporting.DeletedEnrollmentReport" %>
    ...
    <div class="tabcontainer widetabcontainer">
        <div class="tabcontent">
            ...
            <asp:ValidationSummary ID="ValidationSummary" runat="server" ValidationGroup="ReportParameters"
                DisplayMode="List" />
            <uc:ReportViewport ID="ReportViewport" runat="server" ReportName="BulkDeletedEnrollmentReport" />
        </div>
    </div>    
</asp:Content>
