...
{
    public partial class DeletedEnrollmentReport : Page, IReportParametersContainer
    {
        ...
        public IEnumerable<ReportParameter> ReportParameters
        {
            get
            {
                yield return new ReportParameter("startdate", StartDate.ToShortDateString());
                yield return new ReportParameter("enddate", EndDate.ToShortDateString());
