<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/Markup/AdminWide.Master" AutoEventWireup="true" CodeBehind="FriendsAndFamilyReport.aspx.cs" Inherits="POD.Pages.Reporting.FriendsAndFamilyReport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceholder" runat="server">
        ...
        <div class="tabcontent">
            ...
            <asp:ValidationSummary ID="ValidationSummary" runat="server" ValidationGroup="ReportParameters"
                DisplayMode="List" />
            <uc:ReportViewport ID="ReportViewport" runat="server" ReportName="FriendsAndFamilyReport" />
        </div>
    </div>
</asp:Content>
