                    ...
                    <asp:HiddenField ID="hfAssistantSch" runat="server" />
                                 <asp:HiddenField ID="hfInstructorSch" runat="server" />
                                    ...
                                    <%--<div class="InputWrapper">
                                        ...
                                        <asp:Button ID="Button1" Text="Update" runat="server" CssClass="mybutton" CommandName="Update"
                                        ...
                                        &nbsp; &nbsp;
                                        <asp:Button runat="server" ID="Button2" Text="Cancel" CssClass="mybutton" CommandName="Cancel"
