...
namespace POD.Pages.Admin.ManageLocations
{
    public partial class LocationPage : System.Web.UI.Page
    {
        ...
        private void Save()
        {
            ...
            LocationID = POD.Logic.LookUpTypesLogic.AddUpdateLocation(addressid, this.TextBoxName.Text.Trim(), sitename, orgName, this.RadEditoDesc.Content.ToString(), this.checkBoxSite.Checked, parentSiteID, typeid, status, LocationID, lockDate);
        }
